...
SECRET_KEY = 'django-insecure-%fdf251nn@fh+f$+3^cwwz##ekib9^xw475!_l_i7$hzh9mr4c'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],  # Ensure templates directory is used
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Ensure static files are loaded properly
